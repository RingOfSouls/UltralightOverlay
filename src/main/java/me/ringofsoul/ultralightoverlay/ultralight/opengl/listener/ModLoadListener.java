package me.ringofsoul.ultralightoverlay.ultralight.opengl.listener;
...
import me.ringofsoul.ultralightoverlay.ultralight.opengl.util.ViewContextProvider;
 ...
 */
public class ModLoadListener implements UltralightLoadListener {
    private final UltralightView view;
    private final Databind databind;
    private final JavaAPI javaApi;

    /**
     * Constructs a new {@link ModLoadListener} for the given view.
     *
     * @param view The view the listener is being constructed for
     */
    public ModLoadListener(UltralightView view) {
        this.view = view;
